...
$total_query = "SELECT COUNT(*) as total FROM posts WHERE is_delete = 0 AND job_type = 'Part Time'";
...
WHERE posts.is_delete = 0 AND job_type = 'Part Time'
...
<h3 class='job-heading'>Time is valuable!</h3>
