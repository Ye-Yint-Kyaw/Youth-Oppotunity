...
$total_query = "SELECT COUNT(*) as total FROM posts WHERE is_delete = 0 AND job_type = 'Volunteer'";
...
WHERE posts.is_delete = 0 AND job_type = 'Volunteer'
...
<h3 class='job-heading'>Be a volunteer!</h3>
