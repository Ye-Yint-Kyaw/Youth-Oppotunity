...
<body>
    <div class="login-box">
        <div class="login">
            ...
            <div class="right">
                <h1><a href="../?content=home"><img src="../img/green_logo.png" alt="Logo"></a></h1>
                <form class="login-form" id="login-form" method='POST' action='logindata.php'>
                    ...
                    <a href="forgetpassword.php" class="forgot-password">Forgot Password?</a><a class="forgot-password" href="register.php">Or create new account?</a>
                </form>
                <?php
