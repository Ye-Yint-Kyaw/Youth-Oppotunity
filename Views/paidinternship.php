...
$total_query = "SELECT COUNT(*) as total FROM posts WHERE is_delete = 0 AND job_type = 'Paid Internship'";
...
WHERE posts.is_delete = 0 AND job_type = 'Paid Internship'
...
<h3 class='job-heading'>Start your carier!</h3>
